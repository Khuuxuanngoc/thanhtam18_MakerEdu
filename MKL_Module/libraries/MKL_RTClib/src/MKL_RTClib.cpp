...
/*!
  ...
  - Classes for manipulating dates, times and durations:
    ...
    - MKL_TimeSpan represents the length of a time interval
...
*/
/**************************************************************************/
void MKL_RTC_I2C::write_register(uint8_t reg, uint8_t val) {
...
*/
/**************************************************************************/
uint8_t MKL_RTC_I2C::read_register(uint8_t reg) {
  uint8_t buffer[1];
  i2c_dev->write(&reg, 1);
...
*/
/**************************************************************************/
MKL_DateTime::MKL_DateTime(uint32_t t) {
...
*/
/**************************************************************************/
MKL_DateTime::MKL_DateTime(uint16_t year, uint8_t month, uint8_t day, uint8_t hour,
...
*/
/**************************************************************************/
MKL_DateTime::MKL_DateTime(const MKL_DateTime &copy)
...
/*!
    ...
    ```
    MKL_DateTime buildTime(__DATE__, __TIME__);
    ```
...
*/
/**************************************************************************/
MKL_DateTime::MKL_DateTime(const char *date, const char *time) {
  yOff = conv2d(date + 9);
...
*/
/**************************************************************************/
MKL_DateTime::MKL_DateTime(const __FlashStringHelper *date,
...
/**************************************************************************/
/*!
    @brief  Constructor for creating a MKL_DateTime from an ISO8601 date string.
    ...
    ```
    MKL_DateTime dt("2020-06-25T15:29:37");
    ```
...
*/
/**************************************************************************/
MKL_DateTime::MKL_DateTime(const char *iso8601dateTime) {
...
*/
/**************************************************************************/
bool MKL_DateTime::isValid() const {
  if (yOff >= 100)
    return false;
  MKL_DateTime other(unixtime());
...
char *MKL_DateTime::toString(char *buffer) const {
  uint8_t apTag =
...
*/
/**************************************************************************/
uint8_t MKL_DateTime::twelveHour() const {
...
*/
/**************************************************************************/
uint8_t MKL_DateTime::dayOfTheWeek() const {
...
/*!
    ...
    @see The `MKL_DateTime::MKL_DateTime(uint32_t)` constructor is the converse of
        this method.

    @return Number of seconds since 1970-01-01 00:00:00.
*/
/**************************************************************************/
uint32_t MKL_DateTime::unixtime(void) const {
  uint32_t t;
...
*/
/**************************************************************************/
uint32_t MKL_DateTime::secondstime(void) const {
  uint32_t t;
  uint16_t days = date2days(yOff, m, d);
  t = time2ulong(days, hh, mm, ss);
  return t;
...
/**************************************************************************/
/*!
    @brief  Add a MKL_TimeSpan to the DateTime object
    @param span MKL_TimeSpan object
    @return New DateTime object with span added to it.
*/
/**************************************************************************/
MKL_DateTime MKL_DateTime::operator+(const MKL_TimeSpan &span) const {
  return MKL_DateTime(unixtime() + span.totalseconds());
}

/**************************************************************************/
/*!
    @brief  Subtract a MKL_TimeSpan from the DateTime object
    @param span MKL_TimeSpan object
...
/*!
    ...
    @note Since a MKL_TimeSpan cannot be negative, the subtracted DateTime
    ...
    @return MKL_TimeSpan of the difference between DateTimes.
*/
/**************************************************************************/
MKL_TimeSpan MKL_DateTime::operator-(const MKL_DateTime &right) const {
  return MKL_TimeSpan(unixtime() - right.unixtime());
}
...
*/
/**************************************************************************/
bool MKL_DateTime::operator<(const MKL_DateTime &right) const {
...
*/
/**************************************************************************/
String MKL_DateTime::timestamp(timestampOpt opt) const {
...
/**************************************************************************/
/*!
    @brief  Create a new MKL_TimeSpan object in seconds
    @param seconds Number of seconds
*/
/**************************************************************************/
MKL_TimeSpan::MKL_TimeSpan(int32_t seconds) : _seconds(seconds) {}

/**************************************************************************/
/*!
    @brief  Create a new MKL_TimeSpan object using a number of
   days/hours/minutes/seconds e.g. Make a MKL_TimeSpan of 3 hours and 45 minutes:
   new MKL_TimeSpan(0, 3, 45, 0);
...
*/
/**************************************************************************/
MKL_TimeSpan::MKL_TimeSpan(int16_t days, int8_t hours, int8_t minutes, int8_t seconds)
    : _seconds((int32_t)days * 86400L + (int32_t)hours * 3600 +
               (int32_t)minutes * 60 + seconds) {}

/**************************************************************************/
/*!
    @brief  Copy constructor, make a new MKL_TimeSpan using an existing one
    @param copy The MKL_TimeSpan to copy
*/
/**************************************************************************/
MKL_TimeSpan::MKL_TimeSpan(const MKL_TimeSpan &copy) : _seconds(copy._seconds) {}

/**************************************************************************/
/*!
    @brief  Add two MKL_TimeSpans
    @param right MKL_TimeSpan to add
    @return New MKL_TimeSpan object, sum of left and right
*/
/**************************************************************************/
MKL_TimeSpan MKL_TimeSpan::operator+(const MKL_TimeSpan &right) const {
  return MKL_TimeSpan(_seconds + right._seconds);
}

/**************************************************************************/
/*!
    @brief  Subtract a MKL_TimeSpan
    @param right MKL_TimeSpan to subtract
    @return New MKL_TimeSpan object, right subtracted from left
*/
/**************************************************************************/
MKL_TimeSpan MKL_TimeSpan::operator-(const MKL_TimeSpan &right) const {
  return MKL_TimeSpan(_seconds - right._seconds);
