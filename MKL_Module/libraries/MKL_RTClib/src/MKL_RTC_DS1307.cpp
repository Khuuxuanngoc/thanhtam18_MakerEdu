...
*/
/**************************************************************************/
bool MKL_RTC_DS1307::begin(TwoWire *wireInstance) {
  if (i2c_dev)
    delete i2c_dev;
...
*/
/**************************************************************************/
uint8_t MKL_RTC_DS1307::isrunning(void) { return !(read_register(0) >> 7); }
...
*/
/**************************************************************************/
void MKL_RTC_DS1307::adjust(const MKL_DateTime &dt) {
  uint8_t buffer[8] = {0,
                       bin2bcd(dt.second()),
                       bin2bcd(dt.minute()),
                       bin2bcd(dt.hour()),
...
*/
/**************************************************************************/
MKL_DateTime MKL_RTC_DS1307::now() {
  uint8_t buffer[7];
  buffer[0] = 0;
...
*/
/**************************************************************************/
Ds1307SqwPinMode MKL_RTC_DS1307::readSqwPinMode() {
...
*/
/**************************************************************************/
void MKL_RTC_DS1307::writeSqwPinMode(Ds1307SqwPinMode mode) {
...
*/
/**************************************************************************/
void MKL_RTC_DS1307::readnvram(uint8_t *buf, uint8_t size, uint8_t address) {
...
*/
/**************************************************************************/
void MKL_RTC_DS1307::writenvram(uint8_t address, const uint8_t *buf, uint8_t size) {
  uint8_t addrByte = DS1307_NVRAM + address;
...
*/
/**************************************************************************/
uint8_t MKL_RTC_DS1307::readnvram(uint8_t address) {
  uint8_t data;
...
*/
/**************************************************************************/
void MKL_RTC_DS1307::writenvram(uint8_t address, uint8_t data) {
