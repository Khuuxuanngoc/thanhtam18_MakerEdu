...
#ifndef MKL_RTCLIB_H_
#define MKL_RTCLIB_H_
...
class MKL_DateTime {
public:
  MKL_DateTime(uint32_t t = SECONDS_FROM_1970_TO_2000);
  MKL_DateTime(uint16_t year, uint8_t month, uint8_t day, uint8_t hour = 0,
           uint8_t min = 0, uint8_t sec = 0);
  MKL_DateTime(const MKL_DateTime &copy);
  MKL_DateTime(const char *date, const char *time);
  MKL_DateTime(const __FlashStringHelper *date, const __FlashStringHelper *time);
  MKL_DateTime(const char *iso8601date);
  bool isValid() const;
  ...
  */
  ...
  MKL_DateTime operator+(const MKL_TimeSpan &span) const;
  MKL_DateTime operator-(const MKL_TimeSpan &span) const;
  MKL_TimeSpan operator-(const MKL_DateTime &right) const;
  bool operator<(const MKL_DateTime &right) const;
  ...
  /*!
      ...
      @return True if the left DateTime is later than the right one,
        false otherwise
  */
  bool operator>(const MKL_DateTime &right) const { return right < *this; }
  ...
  */
  bool operator<=(const MKL_DateTime &right) const { return !(*this > right); }
...
class MKL_TimeSpan {
public:
  MKL_TimeSpan(int32_t seconds = 0);
  MKL_TimeSpan(int16_t days, int8_t hours, int8_t minutes, int8_t seconds);
  MKL_TimeSpan(const MKL_TimeSpan &copy);
  ...
  */
  ...
  MKL_TimeSpan operator+(const MKL_TimeSpan &right) const;
  MKL_TimeSpan operator-(const MKL_TimeSpan &right) const;
...
*/
/**************************************************************************/
class MKL_RTC_DS1307 : MKL_RTC_I2C {
public:
  bool begin(TwoWire *wireInstance = &Wire);
  void adjust(const MKL_DateTime &dt);
...
*/
/**************************************************************************/
class MKL_RTC_DS3231 : MKL_RTC_I2C {
public:
  bool begin(TwoWire *wireInstance = &Wire);
  void adjust(const MKL_DateTime &dt);
  bool lostPower(void);
  ...
  bool setAlarm1(const MKL_DateTime &dt, Ds3231Alarm1Mode alarm_mode);
  bool setAlarm2(const MKL_DateTime &dt, Ds3231Alarm2Mode alarm_mode);
  MKL_DateTime getAlarm1();
  MKL_DateTime getAlarm2();
...
*/
/**************************************************************************/
class MKL_RTC_PCF8523 : MKL_RTC_I2C {
public:
  bool begin(TwoWire *wireInstance = &Wire);
  void adjust(const MKL_DateTime &dt);
  bool lostPower(void);
...
*/
/**************************************************************************/
class MKL_RTC_PCF8563 : MKL_RTC_I2C {
public:
  bool begin(TwoWire *wireInstance = &Wire);
  bool lostPower(void);
  void adjust(const MKL_DateTime &dt);
...
*/
/**************************************************************************/
class MKL_RTC_Millis {
public:
  /*!
      @brief  Start the RTC
      @param dt DateTime object with the date/time to set
  */
  void begin(const MKL_DateTime &dt) { adjust(dt); }
  void adjust(const MKL_DateTime &dt);
  MKL_DateTime now();
