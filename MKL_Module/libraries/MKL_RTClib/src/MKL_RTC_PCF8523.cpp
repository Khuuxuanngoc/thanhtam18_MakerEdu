...
*/
/**************************************************************************/
bool MKL_RTC_PCF8523::begin(TwoWire *wireInstance) {
  if (i2c_dev)
    delete i2c_dev;
...
*/
/**************************************************************************/
bool MKL_RTC_PCF8523::lostPower(void) {
...
*/
/**************************************************************************/
bool MKL_RTC_PCF8523::initialized(void) {
...
/*!
    ...
    @param dt MKL_DateTime to set
*/
/**************************************************************************/
void MKL_RTC_PCF8523::adjust(const MKL_DateTime &dt) {
...
*/
/**************************************************************************/
MKL_DateTime MKL_RTC_PCF8523::now() {
  uint8_t buffer[7];
  buffer[0] = 3;
  i2c_dev->write_then_read(buffer, 1, buffer, 7);

  return MKL_DateTime(bcd2bin(buffer[6]) + 2000U, bcd2bin(buffer[5]),
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::start(void) {
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::stop(void) {
...
*/
/**************************************************************************/
uint8_t MKL_RTC_PCF8523::isrunning() {
...
*/
/**************************************************************************/
Pcf8523SqwPinMode MKL_RTC_PCF8523::readSqwPinMode() {
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::writeSqwPinMode(Pcf8523SqwPinMode mode) {
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::enableSecondTimer() {
  uint8_t ctlreg = read_register(PCF8523_CONTROL_1);
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::disableSecondTimer() {
  write_register(PCF8523_CONTROL_1,
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::enableCountdownTimer(PCF8523TimerClockFreq clkFreq,
                                       uint8_t numPeriods,
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::disableCountdownTimer() {
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::deconfigureAllTimers() {
...
*/
/**************************************************************************/
void MKL_RTC_PCF8523::calibrate(Pcf8523OffsetMode mode, int8_t offset) {
