...
void setup() {
  ...
  // MKL_DateTime::secondstime() use the start of year 2000 as their
  // reference "epoch".
...
void loop() {
  ...
  // similar to the MKL_DateTime class. Unlike localtime(), it doesn't
  ...
  // the MKL_DateTime::toString() format "DDD MMM DD hh:mm:ss YYYY".
