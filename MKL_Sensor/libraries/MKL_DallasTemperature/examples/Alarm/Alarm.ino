...
MKL_OneWire oneWire(ONE_WIRE_BUS);

// Pass our oneWire reference to Dallas Temperature. 
MKL_DallasTemperature sensors(&oneWire);
...
void printTemperature(DeviceAddress deviceAddress)
{
  ...
  Serial.print(tempC);
  Serial.print(" Temp F: ");
  Serial.print(MKL_DallasTemperature::toFahrenheit(tempC));
}
...
void printAlarms(uint8_t deviceAddress[])
{
  ...
  Serial.print("C/");
  Serial.print(MKL_DallasTemperature::toFahrenheit(temp));
