...
MKL_OneWire oneWire_in(ONE_WIRE_BUS_1);
MKL_OneWire oneWire_out(ONE_WIRE_BUS_2);

MKL_DallasTemperature sensor_inhouse(&oneWire_in);
MKL_DallasTemperature sensor_outhouse(&oneWire_out);
