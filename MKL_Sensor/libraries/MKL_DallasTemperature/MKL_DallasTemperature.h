#ifndef MKL_DallasTemperature_h
#define MKL_DallasTemperature_h
...
class MKL_DallasTemperature {
public:

	MKL_DallasTemperature();
	MKL_DallasTemperature(MKL_OneWire*);
	MKL_DallasTemperature(MKL_OneWire*, uint8_t);

	void setOneWire(MKL_OneWire*);
